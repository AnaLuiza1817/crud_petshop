...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $sqlAnimal = "INSERT INTO animais (nome, especie, raca, idade, peso, id_cliente)
                      VALUES (:nome, :especie, :raca, :idade, :peso, :id_cliente)";
...
<body>
    <div class="container">
        <div class="topo">
            ...
            <a href="gerencie.php" class="link-voltar">Ver Gerenciamento</a>
        </div>
        <p class="subtitulo">
        ...
        <form method="POST">
            <h2 class="secao">Dados do Responsável</h2>
            ...
            <h2 class="secao">Dados do Pet</h2>
